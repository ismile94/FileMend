...
var AxiosError$1 = class _AxiosError$1 extends Error {
  static from(error, code, config, request, response, customProps) {
    const axiosError = new _AxiosError$1(error.message, code || error.code, config, request, response);
...
var Axios$2 = Axios$1;
var CancelToken$1 = class _CancelToken$1 {
  ...
  static source() {
    let cancel;
    const token = new _CancelToken$1(function executor(c) {
      cancel = c;
    });
    return {
      token,
